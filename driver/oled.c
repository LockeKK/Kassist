...
void LED_PrintChar(u8 ucIdxX, u8 ucIdxY, s8 cData)
{
    ...
    LED_P6x8Char((u8)(ucIdxX+6), ucIdxY, (u8)(i+48));
    LED_P6x8Char((u8)(ucIdxX+12), ucIdxY, (u8)(j+48));
    LED_P6x8Char((u8)(ucIdxX+18), ucIdxY, (u8)(k+48));   
...
void LED_PrintShort(u8 ucIdxX, u8 ucIdxY, s16 sData)
{
    ...
    LED_P6x8Char((u8)(ucIdxX+6), ucIdxY, (u8)(l+48));
    LED_P6x8Char((u8)(ucIdxX+12), ucIdxY, (u8)(m+48));
    LED_P6x8Char((u8)(ucIdxX+18), ucIdxY, (u8)(i+48));
    LED_P6x8Char((u8)(ucIdxX+24), ucIdxY, (u8)(j+48));
    LED_P6x8Char((u8)(ucIdxX+30), ucIdxY, (u8)(k+48));  
