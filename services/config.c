...
#endif
	{
		{CH3_SINGLE, 		POS_INC,			CH_PWM0,	BEEP(0, 1)	},
		{CH3_DOUBLE, 		POS_DEC,			CH_PWM0,	BEEP(0, 2)	},
		{CH3_TRIPLE, 		POS_INC,			CH_PWM1,	BEEP(0, 3)	},
		{CH3_TURNOVER, 		NO_ACTION,			CH_NONE,	BEEP(1, 0)	},
		{CH3_TO_SINGLE,		CH3_TOGGLE,			CH_PWM2,	BEEP(1, 1)	},
		{CH3_TO_DOUBLE,		CH3_TOGGLE,			CH_PWM3,	BEEP(1, 2)	},
		{CH3_TO_TRIPLE,		AUTOGEAR_TOGGLE,	CH_EVENT0,	BEEP(1, 3)	},	
		{CH3_TO_OFF,		NO_ACTION,			CH_NONE,	BEEP(1, 1)	}
	},
